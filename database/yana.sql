...
(26, 27, 'Perspiciatis offici', 'Deserunt et vel saep', 'Shelley_edu16663917581541210689.pdf', './uploads/educatoinal_doc/', NULL, ''),
(27, 28, 'Et cupiditate velit', 'Molestiae fugiat ea', 'Hunter_edu1666400830677383346.pdf', './uploads/educatoinal_doc/', NULL, ''),
(28, 29, 'Sit excepteur dolori', 'Esse proident aspe', 'Pandora_edu1666400859280595824.pdf', './uploads/educatoinal_doc/', NULL, '');
...
(17, 7, '11:11', '00:00', '2022-10-21', 1, '2000.00', 'hefhe'),
(18, 7, '13:00', '14:00', '2022-10-22', 1, '600.00', 'hhuhjoi'),
(19, 2, '18:53', '21:12', '2022-10-22', 3, '76.00', 'N/A'),
(20, 2, '12:57', '02:02', '2022-10-22', 4, '2000.00', 'Sit eligendi dicta '),
(21, 2, '19:58', '00:08', '2022-10-22', 5, '1000.00', 'Voluptas sed error s'),
(22, 7, '12:33', '00:33', '2022-10-22', 8, '800.00', 'gseyfgiushfu;w');
...
INSERT INTO `social_user_link` (`id`, `link`, `user_id`, `medium_id`, `appointment_id`) VALUES
(1, 'https://meet.google.com/mqv-hhqf-una', 4, 7, 11),
(2, 'https://meet.google.com/twj-dudn-zrr', 7, 7, 14),
(4, 'https://meet.google.com/mqv-hhqf-una', 20, 7, 13),
(5, 'https://meet.google.com/mqv-hhqf-una', 21, 7, 16);
...
(2, 'Jemmy', 'Lehri', 'doctor@gmail.com', 'male', '1994-10-12', '26d4fccb3c81e8855dc60ed8b037f801', 5, '5', '015454545', 'london', 'London', '41444', NULL, NULL, 3, 1),
(4, 'rayhan', 'ahmed', 'counselor@gmail.com', 'male', '1994-09-25', 'bc604979ecf3850b4afba3b11a764d03', 5, '5', '0174545944', 'Savar', 'Dhaka', '1241', '_pp1665844327546601243.jpg', './uploads/', 2, 1),
...
(6, 'mayesha', 'fahmida', 'mayesha@gmail.com', 'male', '1996-09-25', 'd9c437fb39ade8dd0a687d1e1192018c', 5, '5', '8888888', 'Dhaka', 'Dhaka', '1221', 'bikash_pp16657969201934904944.jpg', './uploads/', 4, 1),
(7, 'Tonoya', 'Rahman', 'tonoya@gmail.com', 'female', '1996-09-25', '4527e751ff115929c43480bd26626c34', 5, '5', '01745459110', 'N.Ganj', 'N.Ganj', '1221', '_pp1666220643486043412.jpg', './uploads/', 3, 1),
...
(27, 'Shelley', 'Rowe', 'paqovynovy@mailinator.com', 'other', '1993-12-26', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 47, '48', '471', 'Est dolor exercitati', 'Alias earum sunt eiu', '32852', 'Shelley_pp16663917581983886013.jpg', './uploads/profile_photo/', 2, NULL),
(28, 'Hunter', 'Bradshaw', 'xenavu@mailinator.com', 'male', '1984-06-06', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 198, '121', '691', 'Aut repellendus Vol', 'Tempore molestias d', '98302', '', '', 2, NULL),
(29, 'Pandora', 'Mathis', 'rifu@mailinator.com', 'female', '1989-03-21', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 158, '40', '945', 'Commodi ea pariatur', 'Expedita maxime eu s', '27221', '', '', 3, NULL);
...
ALTER TABLE `social_user_link`
  ...
  ADD CONSTRAINT `social_user_link_ibfk_3` FOREIGN KEY (`appointment_id`) REFERENCES `appointment` (`id`);
