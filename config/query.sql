...
-- |-- Dumbing data for social medium --|
INSERT INTO social_medium(medium)
VALUES
   ("facebook"),
    ("youtube"),
    ("website"),
...
-- ALTER TABLE test DROP PRIMARY KEY, change id id int NOT NULL;
-- |++++++++++++Alter foreign key ++++++++++++|--
-- |-- ADD foreign key --|
/*
 ALTER TABLE test
...
-- 	VALUES
-- 	( 'Bikash', 'Chowdhury', 'chowdhurybikash73@yahoo.com', 'male', '2021-10-20', 'ffffffff', 2 , 'phone-code', '01541555', 'adfasdfa', 'city_name', '221515', '', 'storage/pp/',2 );


-- INSERT INTO additional_info( education, workiing_place, document_name, document_location ) VALUES( 'adfasdf', 'adsfasdf', 'query.sql', 'storage/document/' );