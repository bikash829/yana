            ...
            <form name="frm_councilor" action="./backend/reg.php" method="POST" class="row g-3 needs-validation register" novalidate>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group has-validation form-floating">
                        <textarea name="education_info" class="form-control" id="qualification" style="height: 4rem" placeholder="" required></textarea>
                        <label for="qualification">Important</label>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group has-validation form-floating">
                        <textarea name="working_info" class="form-control" id="work_info" placeholder="" style="height: 4rem"></textarea>
                        <label for="work_info">Optional</label>
                ...
                <div class="col-12 d-grid">
                    <button name="btn-councilor" value="frm-councilor" class="btn btn-primary" type="submit">Register Now</button>
                </div>
            </form>
